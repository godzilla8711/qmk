...
/* Keymap (Base Layer) Default Layer
   ...
   * |     |   |   |   |   |   |   |   |   |   |PSc|   |   |     |    |
   * |----------------------------------------------------------------|
   * |     |   |   |    |Bksp|Del|Lef|Dwn| Up|Rig|   |   |Return  |   |
   * |----------------------------------------------------------------|
   * |        |   |   |   |   |   |Mac1|Mac2|   |   |  |     |PUp|    |
   * |----------------------------------------------------------------|
   * |    |    |    |         Shft          |   |   |    |Hom|PDn|End |
   ...
   */
    ...
    KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_BSPC, KC_DEL,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_NO,   KC_NO,   KC_ENT,  KC_NO,         \
    KC_TRNS, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   MAC_1,   MAC_2,   KC_NO,   KC_NO,   KC_NO,   KC_TRNS, KC_PGUP, KC_NO,         \
    KC_TRNS, KC_TRNS, KC_TRNS, KC_LSFT,  KC_TRNS, KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, KC_END)
};
